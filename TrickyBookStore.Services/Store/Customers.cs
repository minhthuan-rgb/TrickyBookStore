...
namespace TrickyBookStore.Services.Store
{
    public static class Customers
    {
        ...
        {
            new Customer{ Id = 1, Name = "Phạm Minh Thuận", SubscriptionIds = new List<int> { 2, 3 } },
            ...
            new Customer{ Id = 5, Name = "Phạm Nguyễn Minh Thư", SubscriptionIds = new List<int> { 2, 5, 4 } },
            new Customer{ Id = 6, Name = "Phạm Đức Thịnh", SubscriptionIds = new List<int> { 2, 3, 5, 4 } },
